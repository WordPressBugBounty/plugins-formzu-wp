...
function formzu_admin_menu() {
    ...
    $load_slug_list['formzu'] = add_submenu_page(
        $slug_list['formzu'],
    ...
    $load_slug_list['howtouse'] = add_submenu_page(
        $slug_list['formzu'],
    ...
    do_action( 'formzu_loaded_menu', $slug_list, $load_slug_list );
}
